...
def main(args):
    msrvtt_train_dataset = MSRVTT_Captioning_Dataset(os.path.join(args.path_to_MSRVTT, "TrainValVideo"), args.capture_every)
    ...
    for video_id, frames in tqdm(msrvtt_train_dataset):
        text = "A picture of"
